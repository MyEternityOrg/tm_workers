"""
Django settings for tm_workers project.
...
SECRET_KEY = 'django-insecure-1u_69je%xqs5!n&@i2x)&c0%dv&m^-7m_y1b-p^(*#w!4**46&'
...
WSGI_APPLICATION = 'tm_workers.wsgi.application'
